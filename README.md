...
│       │   ├── ollama.py                # Ollama-based LLM implementation
│       │   └── openai.py                # OpenAI-based LLM implementation
...
└── tests/                               # Test suite
    ...
    └── unit/                            # Unit tests grouped by subsystem
        ...
        │   ├── test_ollama.py           # Ollama implementation tests
        │   └── test_openai.py           # OpenAI implementation tests
